 ...
 * Values may be any mix of { JSONObject JSONObjects}, { JSONArray
...
class JSONObject {
   ...
   * { JSONArray}. Using {@code accumulate} will result in either a
   * { JSONArray} or a mapping whose type is the type of {@code value}
  ...
  /**
   * Appends values to the array mapped to {@code name}. A new { JSONArray}
   * mapping for {@code name} will be inserted if no mapping exists. If the existing
   * mapping for {@code name} is not a { JSONArray}, a { JSONException}
   * will be thrown.
   *
   * @throws JSONException if {@code name} is {@code null} or if the mapping for
   *                       {@code name} is non-null and is not a { JSONArray}.
   * @hide
   */
   ...
   *                       to a boolean.
   */
  public boolean getBoolean(String name) throws JSONException, JSONException {
   ...
   *                     nesting.
   */
  String toString(int indentSpaces) throws JSONException {
