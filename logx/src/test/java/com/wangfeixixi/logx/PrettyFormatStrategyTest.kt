...
class PrettyFormatStrategyTest {
  ...
  private val builder = LogcatFormatStrategy.newBuilder().logStrategy(logStrategy)
  ...
  // TODO: assert values, for now this checks that LogAndroid doesn't crash
  ...
  private class MockLogStrategy : ILogStrategy {
